  ...
  return (
    <div className="px-6 md:px-16 lg:px-24 xl:px-32 bg-primary/3">
      <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-gray-500/30 text-gray-500">
        <div>
          ...
          <p className="max-w-[410px] mt-6">
            A simple, secure, and fast blogging platform. Write your story
            without worrying about server management. Focus on what matters most
            - your content!
          </p>
        </div>
      ...
      <p className="py-4 text-center text-sm md:text-base text-gray-500">
        Copyright 2025 © Quick Blog - All Rights Reserved
      </p>
    </div>
  );
};
